<?php echo !defined("ADMIN") ? die("Hacking?") : null; ?>
		...
		<?php
			...
			if ($_POST){
				...
				if (!$name_az){
					echo '<div class="alert alert-danger">Bölmə başlığını boş buraxmaq olmaz.</div>';
				}else {


						$insert = query("INSERT INTO product_product SET
						name_az = '$name_az',
						name_eng = '$name_eng',
						name_rus = '$name_rus'");

						if ($insert){
							echo '<div class="alert alert-success">Bölmə əlavə olundu. Yönləndirilirsiniz.</div>';
					...
					<div class="col-sm-12 portlets ui-sortable">
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong>Məhsul</strong> Bölmə Əlavə Et</h2>
							</div>
